...
\item Receiving Promise had at best no impact on Fall to Spring retention.
\item Earning a higher Fall GPA, taking more semester credits and receiving Pell funds all had positive impacts on Fall to Spring retention. However, all of these are related to the requirements of Promise, which makes it difficult to attribute retention uniquely to the effect of funds distributed by Promise.
\end{itemize}
...
nothing was significant in the matching with the exception of first time student with cummulative gpa, they were negative and significant.

need a table for all of the results for all three groups. 
